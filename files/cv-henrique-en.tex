...
\section{SKILLS}
{\sl Strong:} Python (3+ years), JavaScript (2+ years), C (2+ years) \\
{\sl Knowledgeable:} Git, C++, Java, Linux Device Drivers, Lisp, SQL
...
Project DYnamic Code Profiling - Development of a code profiler for ARM architecture funded by a Samsung Scholarship \
\begin{itemize} \itemsep -1pt % Reduce space between items
\item Assisted the design and development of a dynamic profiler to catch hotspots on code for ARM architecture for the use of a testing team.
\end{itemize}
...
\section{EXPERIENCE}
{\bf Software Developer Internship} \hfill Dez 2017 - Present \\
Daitan Group, Campinas, São Paulo, Brazil
\begin{itemize}
\item Development of a wrapper around not integrated systems to create a unique and well-designed interface for the client. Used Javascript [Node.js].\\
\end{itemize}
